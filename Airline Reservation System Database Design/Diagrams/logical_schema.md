...
|----------------|--------------------|-----------------------------------------------|--------------------|
|     ID     |     INT            |     Unique row id.                            |     Primary Key    |
...
|----------------|--------------------|-----------------------------------------------|--------------------|
|     ID     |     INT            |     Unique row id.                            |     Primary Key    |
|     Person_ID       |     INT    |     Foreign Key pointing to Person                           |     Foreign Key|
...
|     ID         |     INT            |     Unique row id.    |     Primary key     |
|     Person_ID       |     INT    |     Foreign Key pointing to Person                           |    Foreign Key|
|     Contact_Number          |     INT    |     Cell phone number(s)              |     NOT NULL        |
...
|     ID         |     INT            |     Unique row id.    |     Primary key     |
|     Person_ID       |     INT    |     Foreign Key pointing to Person                           |    Foreign Key|
|     Email_Address         |     Varchar(50)     |     Email(s) of that person     |     NOT NULL        |
